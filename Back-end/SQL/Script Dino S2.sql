...
VALUES 
    ('44444444444', 'DinosaurioMall', 'Av. Rodriguez', 441, '351-4444444');
GO
...
VALUES 
    (1, 'Dinosaurio Mall - RDB', 'Rodríguez del Busto', 4086, '0351-477-8550', -31.3768, -64.2166, 3, 1),
    (2, 'Dinosaurio Mall - San Martin', 'Av. San Martín', 1800, '03541-432-200', -31.4245, -64.5012, 4, 1),
    (3, 'Dinosaurio Mall - Las Heras', 'Av. Las Heras', 600, '0261-429-3500', -32.8894, -68.8458, 7, 1),
    (4, 'Dinosaurio Mall - Paraguay', 'Av. Paraguay', 1500, '0387-431-1200', -24.7944, -65.4115, 9, 1);
GO
...
VALUES
    (1, '7790001000011', 120.30, 1),  -- Leche Entera La Serenísima
    (1, '7790011000001', 220.80, 1),  -- Leche de Almendras Silk
    (1, '7790011000002', 235.60, 1),  -- Yogur Vegano
    (1, '7790002000011', 410.20, 1),  -- Bife de Res
    (1, '7790012000003', 215.50, 1),  -- Salchichas Viena
    (1, '7790012000004', 380.90, 1),  -- Costilla de Cerdo
    (1, '7790013000005', 280.45, 1),  -- Frutillas Congeladas
    (1, '7790013000006', 122.30, 1),  -- Zanahorias Baby
    (1, '7790003000011', 65.20, 1),   -- Manzanas Rojas
    (1, '7790003000028', 52.00, 1),   -- Tomates
    (1, '7790004000011', 130.80, 1),  -- Pan de Molde Blanco
    (1, '7790004000028', 135.90, 1),  -- Facturas Variadas
    (1, '7790014000007', 150.50, 1),  -- Baguette Artesanal
    (1, '7790014000008', 88.50, 1),   -- Galletas Digestivas
    (1, '7790005000011', 222.30, 1),  -- Gaseosa Regular Coca-Cola
    (1, '7790005000028', 87.50, 1),   -- Agua Mineral con Gas
    (1, '7790005000035', 360.50, 1),  -- Vino Tinto
    (1, '7790015000009', 42.80, 1),   -- Té Chai
    (1, '7790015000010', 320.75, 1),  -- Vino Rosado
    (1, '7790006000011', 85.40, 1),   -- Lentejas
    (1, '7790006000028', 95.20, 1),   -- Atún en Lata
    (1, '7790016000011', 115.50, 1),  -- Garbanzos
    (1, '7790016000012', 98.70, 1),   -- Porotos Rojos
    (1, '7790017000013', 72.00, 1),   -- Pasta Dental Blanqueadora
    (1, '7790017000014', 142.60, 1),  -- Acondicionador Hidratante
    (1, '7790007000011', 85.20, 1),   -- Papel Higiénico Doble Hoja
    (1, '7790007000028', 100.00, 1),  -- Shampoo Anticaspa
    (1, '7790008000011', 77.80, 1),   -- Lavandina
    (1, '7790008000028', 165.40, 1),  -- Detergente para Ropa
    (1, '7790018000015', 102.50, 1),  -- Limpiador Multiuso
    (1, '7790018000016', 110.20, 1),  -- Suavizante para Ropa
    (1, '7790009000028', 72.90, 1),   -- Café Instantáneo
    (1, '7790009000035', 188.60, 1),  -- Yerba Mate
    (1, '7790009000059', 88.50, 1),   -- Galletas Sin Gluten
    (1, '7790009000066', 220.00, 1),  -- Cerveza Artesanal

    (2, '7790001000011', 120.30, 1),  -- Leche Entera La Serenísima
    (2, '7790011000001', 220.80, 1),  -- Leche de Almendras Silk
    (2, '7790011000002', 235.60, 1),  -- Yogur Vegano
    (2, '7790002000011', 410.20, 1),  -- Bife de Res
    (2, '7790012000003', 215.50, 1),  -- Salchichas Viena
    (2, '7790012000004', 380.90, 1),  -- Costilla de Cerdo
    (2, '7790013000005', 280.45, 1),  -- Frutillas Congeladas
    (2, '7790013000006', 122.30, 1),  -- Zanahorias Baby
    (2, '7790003000011', 65.20, 1),   -- Manzanas Rojas
    (2, '7790003000028', 52.00, 1),   -- Tomates
    (2, '7790004000011', 130.80, 1),  -- Pan de Molde Blanco
    (2, '7790004000028', 135.90, 1),  -- Facturas Variadas
    (2, '7790014000007', 150.50, 1),  -- Baguette Artesanal
    (2, '7790014000008', 88.50, 1),   -- Galletas Digestivas
    (2, '7790005000011', 222.30, 1),  -- Gaseosa Regular Coca-Cola
    (2, '7790005000028', 87.50, 1),   -- Agua Mineral con Gas
    (2, '7790005000035', 360.50, 1),  -- Vino Tinto
    (2, '7790015000009', 42.80, 1),   -- Té Chai
    (2, '7790015000010', 320.75, 1),  -- Vino Rosado
    (2, '7790006000011', 85.40, 1),   -- Lentejas
    (2, '7790006000028', 95.20, 1),   -- Atún en Lata
    (2, '7790016000011', 115.50, 1),  -- Garbanzos
    (2, '7790016000012', 98.70, 1),   -- Porotos Rojos
    (2, '7790017000013', 72.00, 1),   -- Pasta Dental Blanqueadora
    (2, '7790017000014', 142.60, 1),  -- Acondicionador Hidratante
    (2, '7790007000011', 85.20, 1),   -- Papel Higiénico Doble Hoja
    (2, '7790007000028', 100.00, 1),  -- Shampoo Anticaspa
    (2, '7790008000011', 77.80, 1),   -- Lavandina
    (2, '7790008000028', 165.40, 1),  -- Detergente para Ropa
    (2, '7790018000015', 102.50, 1),  -- Limpiador Multiuso
    (2, '7790018000016', 110.20, 1),  -- Suavizante para Ropa
    (2, '7790009000028', 72.90, 1),   -- Café Instantáneo
    (2, '7790009000035', 188.60, 1),  -- Yerba Mate
    (2, '7790009000059', 88.50, 1),   -- Galletas Sin Gluten
    (2, '7790009000066', 220.00, 1),  -- Cerveza Artesanal

    (3, '7790001000011', 120.30, 1),  -- Leche Entera La Serenísima
    (3, '7790011000001', 220.80, 1),  -- Leche de Almendras Silk
    (3, '7790011000002', 235.60, 1),  -- Yogur Vegano
    (3, '7790002000011', 410.20, 1),  -- Bife de Res
    (3, '7790012000003', 215.50, 1),  -- Salchichas Viena
    (3, '7790012000004', 380.90, 1),  -- Costilla de Cerdo
    (3, '7790013000005', 280.45, 1),  -- Frutillas Congeladas
    (3, '7790013000006', 122.30, 1),  -- Zanahorias Baby
    (3, '7790003000011', 65.20, 1),   -- Manzanas Rojas
    (3, '7790003000028', 52.00, 1),   -- Tomates
    (3, '7790004000011', 130.80, 1),  -- Pan de Molde Blanco
    (3, '7790004000028', 135.90, 1),  -- Facturas Variadas
    (3, '7790014000007', 150.50, 1),  -- Baguette Artesanal
    (3, '7790014000008', 88.50, 1),   -- Galletas Digestivas
    (3, '7790005000011', 222.30, 1),  -- Gaseosa Regular Coca-Cola
    (3, '7790005000028', 87.50, 1),   -- Agua Mineral con Gas
    (3, '7790005000035', 360.50, 1),  -- Vino Tinto
    (3, '7790015000009', 42.80, 1),   -- Té Chai
    (3, '7790015000010', 320.75, 1),  -- Vino Rosado
    (3, '7790006000011', 85.40, 1),   -- Lentejas
    (3, '7790006000028', 95.20, 1),   -- Atún en Lata
    (3, '7790016000011', 115.50, 1),  -- Garbanzos
    (3, '7790016000012', 98.70, 1),   -- Porotos Rojos
    (3, '7790017000013', 72.00, 1),   -- Pasta Dental Blanqueadora
    (3, '7790017000014', 142.60, 1),  -- Acondicionador Hidratante
    (3, '7790007000011', 85.20, 1),   -- Papel Higiénico Doble Hoja
    (3, '7790007000028', 100.00, 1),  -- Shampoo Anticaspa
    (3, '7790008000011', 77.80, 1),   -- Lavandina
    (3, '7790008000028', 165.40, 1),  -- Detergente para Ropa
    (3, '7790018000015', 102.50, 1),  -- Limpiador Multiuso
    (3, '7790018000016', 110.20, 1),  -- Suavizante para Ropa
    (3, '7790009000028', 72.90, 1),   -- Café Instantáneo
    (3, '7790009000035', 188.60, 1),  -- Yerba Mate
    (3, '7790009000059', 88.50, 1),   -- Galletas Sin Gluten
    (3, '7790009000066', 220.00, 1),  -- Cerveza Artesanal

    (4, '7790001000011', 120.30, 1),  -- Leche Entera La Serenísima
    (4, '7790011000001', 220.80, 1),  -- Leche de Almendras Silk
    (4, '7790011000002', 235.60, 1),  -- Yogur Vegano
    (4, '7790002000011', 410.20, 1),  -- Bife de Res
    (4, '7790012000003', 215.50, 1),  -- Salchichas Viena
    (4, '7790012000004', 380.90, 1),  -- Costilla de Cerdo
    (4, '7790013000005', 280.45, 1),  -- Frutillas Congeladas
    (4, '7790013000006', 122.30, 1),  -- Zanahorias Baby
    (4, '7790003000011', 65.20, 1),   -- Manzanas Rojas
    (4, '7790003000028', 52.00, 1),   -- Tomates
    (4, '7790004000011', 130.80, 1),  -- Pan de Molde Blanco
    (4, '7790004000028', 135.90, 1),  -- Facturas Variadas
    (4, '7790014000007', 150.50, 1),  -- Baguette Artesanal
    (4, '7790014000008', 88.50, 1),   -- Galletas Digestivas
    (4, '7790005000011', 222.30, 1),  -- Gaseosa Regular Coca-Cola
    (4, '7790005000028', 87.50, 1),   -- Agua Mineral con Gas
    (4, '7790005000035', 360.50, 1),  -- Vino Tinto
    (4, '7790015000009', 42.80, 1),   -- Té Chai
    (4, '7790015000010', 320.75, 1),  -- Vino Rosado
    (4, '7790006000011', 85.40, 1),   -- Lentejas
    (4, '7790006000028', 95.20, 1),   -- Atún en Lata
    (4, '7790016000011', 115.50, 1),  -- Garbanzos
    (4, '7790016000012', 98.70, 1),   -- Porotos Rojos
    (4, '7790017000013', 72.00, 1),   -- Pasta Dental Blanqueadora
    (4, '7790017000014', 142.60, 1),  -- Acondicionador Hidratante
    (4, '7790007000011', 85.20, 1),   -- Papel Higiénico Doble Hoja
    (4, '7790007000028', 100.00, 1),  -- Shampoo Anticaspa
    (4, '7790008000011', 77.80, 1),   -- Lavandina
    (4, '7790008000028', 165.40, 1),  -- Detergente para Ropa
    (4, '7790018000015', 102.50, 1),  -- Limpiador Multiuso
    (4, '7790018000016', 110.20, 1),  -- Suavizante para Ropa
    (4, '7790009000028', 72.90, 1),   -- Café Instantáneo
    (4, '7790009000035', 188.60, 1),  -- Yerba Mate
    (4, '7790009000059', 88.50, 1),   -- Galletas Sin Gluten
    (4, '7790009000066', 220.00, 1);  -- Cerveza Artesanal
GO
