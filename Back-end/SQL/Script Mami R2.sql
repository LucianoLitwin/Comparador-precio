...
VALUES 
    ('32412411552', 'Mami', 'Av. Madre', 3333, '351-3333333');
GO

-- Insertar datos en la tabla sucursales (4 sucursales de Super Mami con localidades corregidas)
INSERT INTO dbo.sucursales (nro_sucursal, nom_sucursal, calle, nro_calle, telefono, coord_latitud, coord_longitud, nro_localidad, habilitada)
VALUES 
    (1, 'Super Mami - Calle 7', 'Calle 7', 450, '0221-456-7890', -34.9214, -57.9545, 1, 1),
    (2, 'Super Mami - Colon', 'Av. Colón', 1200, '0351-789-1234', -31.4159, -64.1833, 3, 1),
    (3, 'Super Mami - Union', 'Union', 1350, '0341-456-6543', -32.9442, -60.6505, 5, 1),
    (4, 'Super Mami - Espana', 'España', 750, '0387-789-9876', -24.7859, -65.4117, 9, 1);
GO

-- Insertar datos en la tabla horarios_sucursales
...
VALUES
    (1, '7790001000011', 135.00, 1),  -- Leche Entera La Serenísima
    (1, '7790011000001', 205.00, 1),  -- Leche de Almendras Silk
    (1, '7790011000002', 230.00, 1),  -- Yogur Vegano
    (1, '7790002000011', 430.00, 1),  -- Bife de Res 
    (1, '7790012000003', 195.00, 1),  -- Salchichas Viena 
    (1, '7790012000004', 410.00, 1),  -- Costilla de Cerdo 
    (1, '7790013000005', 260.00, 1),  -- Frutillas Congeladas 
    (1, '7790013000006', 120.00, 1),  -- Zanahorias Baby 
    (1, '7790003000011', 72.00, 1),   -- Manzanas Rojas
    (1, '7790003000028', 48.00, 1),   -- Tomates 
    (1, '7790004000011', 118.00, 1),  -- Pan de Molde Blanco 
    (1, '7790004000028', 150.00, 1),  -- Facturas Variadas
    (1, '7790014000007', 160.00, 1),  -- Baguette Artesanal 
    (1, '7790014000008', 80.00, 1),   -- Galletas Digestivas
    (1, '7790005000011', 210.00, 1),  -- Gaseosa Regular Coca-Cola 
    (1, '7790005000028', 100.00, 1),  -- Agua Mineral con Gas
    (1, '7790005000035', 300.00, 1),  -- Vino Tinto
    (1, '7790015000009', 45.00, 1),   -- Té Chai
    (1, '7790015000010', 280.00, 1),  -- Vino Rosado 
    (1, '7790006000011', 92.00, 1),   -- Lentejas
    (1, '7790006000028', 80.00, 1),   -- Atún en Lata
    (1, '7790016000011', 110.00, 1),  -- Garbanzos
    (1, '7790016000012', 98.00, 1),   -- Porotos Rojos
    (1, '7790017000013', 80.00, 1),   -- Pasta Dental Blanqueadora
    (1, '7790017000014', 140.00, 1),  -- Acondicionador Hidratante
    (1, '7790007000011', 96.00, 1),   -- Papel Higiénico Doble Hoja
    (1, '7790007000028', 85.00, 1),   -- Shampoo Anticaspa
    (1, '7790008000011', 70.00, 1),   -- Lavandina
    (1, '7790008000028', 140.00, 1),  -- Detergente para Ropa
    (1, '7790018000015', 90.00, 1),   -- Limpiador Multiuso
    (1, '7790018000016', 120.00, 1),  -- Suavizante para Ropa
    (1, '7790009000028', 85.00, 1),   -- Café Instantáneo
    (1, '7790009000035', 175.00, 1),  -- Yerba Mate
    (1, '7790009000059', 78.00, 1),   -- Galletas Sin Gluten
    (1, '7790009000066', 195.00, 1),  -- Cerveza Artesanal

    (2, '7790001000011', 135.00, 1),  -- Leche Entera La Serenísima
    (2, '7790011000001', 205.00, 1),  -- Leche de Almendras Silk
    (2, '7790011000002', 230.00, 1),  -- Yogur Vegano
    (2, '7790002000011', 430.00, 1),  -- Bife de Res 
    (2, '7790012000003', 195.00, 1),  -- Salchichas Viena 
    (2, '7790012000004', 410.00, 1),  -- Costilla de Cerdo 
    (2, '7790013000005', 260.00, 1),  -- Frutillas Congeladas 
    (2, '7790013000006', 120.00, 1),  -- Zanahorias Baby 
    (2, '7790003000011', 72.00, 1),   -- Manzanas Rojas
    (2, '7790003000028', 48.00, 1),   -- Tomates 
    (2, '7790004000011', 118.00, 1),  -- Pan de Molde Blanco 
    (2, '7790004000028', 150.00, 1),  -- Facturas Variadas
    (2, '7790014000007', 160.00, 1),  -- Baguette Artesanal 
    (2, '7790014000008', 80.00, 1),   -- Galletas Digestivas
    (2, '7790005000011', 210.00, 1),  -- Gaseosa Regular Coca-Cola 
    (2, '7790005000028', 100.00, 1),  -- Agua Mineral con Gas
    (2, '7790005000035', 300.00, 1),  -- Vino Tinto
    (2, '7790015000009', 45.00, 1),   -- Té Chai
    (2, '7790015000010', 280.00, 1),  -- Vino Rosado 
    (2, '7790006000011', 92.00, 1),   -- Lentejas
    (2, '7790006000028', 80.00, 1),   -- Atún en Lata
    (2, '7790016000011', 110.00, 1),  -- Garbanzos
    (2, '7790016000012', 98.00, 1),   -- Porotos Rojos
    (2, '7790017000013', 80.00, 1),   -- Pasta Dental Blanqueadora
    (2, '7790017000014', 140.00, 1),  -- Acondicionador Hidratante
    (2, '7790007000011', 96.00, 1),   -- Papel Higiénico Doble Hoja
    (2, '7790007000028', 85.00, 1),   -- Shampoo Anticaspa
    (2, '7790008000011', 70.00, 1),   -- Lavandina
    (2, '7790008000028', 140.00, 1),  -- Detergente para Ropa
    (2, '7790018000015', 90.00, 1),   -- Limpiador Multiuso
    (2, '7790018000016', 120.00, 1),  -- Suavizante para Ropa
    (2, '7790009000028', 85.00, 1),   -- Café Instantáneo
    (2, '7790009000035', 175.00, 1),  -- Yerba Mate
    (2, '7790009000059', 78.00, 1),   -- Galletas Sin Gluten
    (2, '7790009000066', 195.00, 1),  -- Cerveza Artesanal

    (3, '7790001000011', 135.00, 1),  -- Leche Entera La Serenísima
    (3, '7790011000001', 205.00, 1),  -- Leche de Almendras Silk
    (3, '7790011000002', 230.00, 1),  -- Yogur Vegano
    (3, '7790002000011', 430.00, 1),  -- Bife de Res 
    (3, '7790012000003', 195.00, 1),  -- Salchichas Viena 
    (3, '7790012000004', 410.00, 1),  -- Costilla de Cerdo 
    (3, '7790013000005', 260.00, 1),  -- Frutillas Congeladas 
    (3, '7790013000006', 120.00, 1),  -- Zanahorias Baby 
    (3, '7790003000011', 72.00, 1),   -- Manzanas Rojas
    (3, '7790003000028', 48.00, 1),   -- Tomates 
    (3, '7790004000011', 118.00, 1),  -- Pan de Molde Blanco 
    (3, '7790004000028', 150.00, 1),  -- Facturas Variadas
    (3, '7790014000007', 160.00, 1),  -- Baguette Artesanal 
    (3, '7790014000008', 80.00, 1),   -- Galletas Digestivas
    (3, '7790005000011', 210.00, 1),  -- Gaseosa Regular Coca-Cola 
    (3, '7790005000028', 100.00, 1),  -- Agua Mineral con Gas
    (3, '7790005000035', 300.00, 1),  -- Vino Tinto
    (3, '7790015000009', 45.00, 1),   -- Té Chai
    (3, '7790015000010', 280.00, 1),  -- Vino Rosado 
    (3, '7790006000011', 92.00, 1),   -- Lentejas
    (3, '7790006000028', 80.00, 1),   -- Atún en Lata
    (3, '7790016000011', 110.00, 1),  -- Garbanzos
    (3, '7790016000012', 98.00, 1),   -- Porotos Rojos
    (3, '7790017000013', 80.00, 1),   -- Pasta Dental Blanqueadora
    (3, '7790017000014', 140.00, 1),  -- Acondicionador Hidratante
    (3, '7790007000011', 96.00, 1),   -- Papel Higiénico Doble Hoja
    (3, '7790007000028', 85.00, 1),   -- Shampoo Anticaspa
    (3, '7790008000011', 70.00, 1),   -- Lavandina
    (3, '7790008000028', 140.00, 1),  -- Detergente para Ropa
    (3, '7790018000015', 90.00, 1),   -- Limpiador Multiuso
    (3, '7790018000016', 120.00, 1),  -- Suavizante para Ropa
    (3, '7790009000028', 85.00, 1),   -- Café Instantáneo
    (3, '7790009000035', 175.00, 1),  -- Yerba Mate
    (3, '7790009000059', 78.00, 1),   -- Galletas Sin Gluten
    (3, '7790009000066', 195.00, 1),  -- Cerveza Artesanal

    (4, '7790001000011', 135.00, 1),  -- Leche Entera La Serenísima
    (4, '7790011000001', 205.00, 1),  -- Leche de Almendras Silk
    (4, '7790011000002', 230.00, 1),  -- Yogur Vegano
    (4, '7790002000011', 430.00, 1),  -- Bife de Res 
    (4, '7790012000003', 195.00, 1),  -- Salchichas Viena 
    (4, '7790012000004', 410.00, 1),  -- Costilla de Cerdo 
    (4, '7790013000005', 260.00, 1),  -- Frutillas Congeladas 
    (4, '7790013000006', 120.00, 1),  -- Zanahorias Baby 
    (4, '7790003000011', 72.00, 1),   -- Manzanas Rojas
    (4, '7790003000028', 48.00, 1),   -- Tomates 
    (4, '7790004000011', 118.00, 1),  -- Pan de Molde Blanco 
    (4, '7790004000028', 150.00, 1),  -- Facturas Variadas
    (4, '7790014000007', 160.00, 1),  -- Baguette Artesanal 
    (4, '7790014000008', 80.00, 1),   -- Galletas Digestivas
    (4, '7790005000011', 210.00, 1),  -- Gaseosa Regular Coca-Cola 
    (4, '7790005000028', 100.00, 1),  -- Agua Mineral con Gas
    (4, '7790005000035', 300.00, 1),  -- Vino Tinto
    (4, '7790015000009', 45.00, 1),   -- Té Chai
    (4, '7790015000010', 280.00, 1),  -- Vino Rosado 
    (4, '7790006000011', 92.00, 1),   -- Lentejas
    (4, '7790006000028', 80.00, 1),   -- Atún en Lata
    (4, '7790016000011', 110.00, 1),  -- Garbanzos
    (4, '7790016000012', 98.00, 1),   -- Porotos Rojos
    (4, '7790017000013', 80.00, 1),   -- Pasta Dental Blanqueadora
    (4, '7790017000014', 140.00, 1),  -- Acondicionador Hidratante
    (4, '7790007000011', 96.00, 1),   -- Papel Higiénico Doble Hoja
    (4, '7790007000028', 85.00, 1),   -- Shampoo Anticaspa
    (4, '7790008000011', 70.00, 1),   -- Lavandina
    (4, '7790008000028', 140.00, 1),  -- Detergente para Ropa
    (4, '7790018000015', 90.00, 1),   -- Limpiador Multiuso
    (4, '7790018000016', 120.00, 1),  -- Suavizante para Ropa
    (4, '7790009000028', 85.00, 1),   -- Café Instantáneo
    (4, '7790009000035', 175.00, 1),  -- Yerba Mate
    (4, '7790009000059', 78.00, 1),   -- Galletas Sin Gluten
    (4, '7790009000066', 195.00, 1);  -- Cerveza Artesanal
GO
