...
VALUES 
    ('20304567890', 'Disco', 'Av. Colón', 1234, '351-1234567');
GO
...
VALUES 
    (1, 'Disco - Calle 50', 'Calle 50', 300, '0221-456-7890', -34.9207, -57.9534, 1, 1),
    (2, 'Disco - Quiros', 'Av. Duarte Quirós', 1100, '0351-789-4561', -31.4175, -64.1829, 3, 1),
    (3, 'Disco - Orono', 'Bv. Oroño', 800, '0341-456-7892', -32.9471, -60.6303, 5, 1),
    (4, 'Disco - Belgrano', 'Av. Belgrano', 1200, '0387-789-1234', -24.7818, -65.4228, 9, 1),
	(5, 'Disco - Shopping', 'Virgen de la Merced', 1000, '0351-009-1231', -31.3811, -64.2141, 3, 1),
	(6, 'Disco - Diagonal', 'Diagonal', 79, '0351-119-1222', -34.9153, -57.94289, 1, 1);
GO
...
VALUES 
    ...
    (4, 'Domingo', '10:00', '18:00'),

	(5, 'Lunes', '09:00', '21:00'),
    (5, 'Martes', '09:00', '21:00'),
    (5, 'Miércoles', '09:00', '21:00'),
    (5, 'Jueves', '09:00', '21:00'),
    (5, 'Viernes', '09:00', '21:00'),
    (5, 'Sábado', '09:00', '19:00'),
    (5, 'Domingo', '10:00', '18:00'),

	(6, 'Lunes', '09:00', '21:00'),
    (6, 'Martes', '09:00', '21:00'),
    (6, 'Miércoles', '09:00', '21:00'),
    (6, 'Jueves', '09:00', '21:00'),
    (6, 'Viernes', '09:00', '21:00'),
    (6, 'Sábado', '09:00', '19:00'),
    (6, 'Domingo', '10:00', '18:00');
GO
...
VALUES 
	...
	-- Servicios para Disco - Rosario
    (3, 1, 1),  -- Delivery
    (3, 3, 1),  -- Descuentos Exclusivos
    -- Servicios para Disco - Salta Capital
    (4, 2, 1),  -- Recolección en Tienda
    (4, 4, 1),  -- Club de Beneficios

	(5, 1, 1),  -- Recolección en Tienda
    (5, 3, 1),  -- Club de Beneficios

	(6, 2, 1),  -- Recolección en Tienda
    (6, 4, 1);  -- Club de Beneficios
GO
...
VALUES
    -- Sucursal 1: Disco - La Plata
    (1, '7790001000011', 130.00, 1),  -- Leche Entera La Serenísima
    (1, '7790011000001', 210.00, 1),  -- Leche de Almendras Silk
    (1, '7790011000002', 225.75, 1),  -- Yogur Vegano
    (1, '7790002000011', 440.00, 1),  -- Bife de Res
    (1, '7790012000003', 190.75, 1),  -- Salchichas Viena
    (1, '7790012000004', 415.00, 1),  -- Costilla de Cerdo
    (1, '7790013000005', 255.00, 1),  -- Frutillas Congeladas
    (1, '7790013000006', 125.00, 1),  -- Zanahorias Baby
    (1, '7790003000011', 70.50, 1),   -- Manzanas Rojas
    (1, '7790003000028', 50.00, 1),   -- Tomates
    (1, '7790004000011', 115.00, 1),  -- Pan de Molde Blanco
    (1, '7790004000028', 155.50, 1),  -- Facturas Variadas
    (1, '7790014000007', 155.00, 1),  -- Baguette Artesanal
    (1, '7790014000008', 82.50, 1),   -- Galletas Digestivas
    (1, '7790005000011', 200.00, 1),  -- Gaseosa Regular Coca-Cola
    (1, '7790005000028', 105.00, 1),  -- Agua Mineral con Gas
    (1, '7790005000035', 305.00, 1),  -- Vino Tinto
    (1, '7790015000009', 42.50, 1),   -- Té Chai
    (1, '7790015000010', 285.00, 1),  -- Vino Rosado
    (1, '7790006000011', 90.00, 1),   -- Lentejas
    (1, '7790006000028', 82.00, 1),   -- Atún en Lata
    (1, '7790016000011', 108.00, 1),  -- Garbanzos
    (1, '7790016000012', 100.50, 1),  -- Porotos Rojos
    (1, '7790017000013', 78.00, 1),   -- Pasta Dental Blanqueadora
    (1, '7790017000014', 135.00, 1),  -- Acondicionador Hidratante
    (1, '7790007000011', 98.50, 1),   -- Papel Higiénico Doble Hoja
    (1, '7790007000028', 87.00, 1),   -- Shampoo Anticaspa
    (1, '7790008000011', 68.00, 1),   -- Lavandina
    (1, '7790008000028', 145.00, 1),  -- Detergente para Ropa
    (1, '7790018000015', 88.00, 1),   -- Limpiador Multiuso
    (1, '7790018000016', 125.00, 1),  -- Suavizante para Ropa
    (1, '7790009000028', 83.00, 1),   -- Café Instantáneo
    (1, '7790009000035', 170.00, 1),  -- Yerba Mate
    (1, '7790009000059', 80.00, 1),   -- Galletas Sin Gluten
    (1, '7790009000066', 191.00, 1),  -- Cerveza Artesanal

    -- Sucursal 2: Disco - Córdoba Capital
    (2, '7790001000011', 130.00, 1),  -- Leche Entera La Serenísima
    (2, '7790011000001', 210.00, 1),  -- Leche de Almendras Silk
    (2, '7790011000002', 225.75, 1),  -- Yogur Vegano
    (2, '7790002000011', 440.00, 1),  -- Bife de Res
    (2, '7790012000003', 190.75, 1),  -- Salchichas Viena
    (2, '7790012000004', 415.00, 1),  -- Costilla de Cerdo
    (2, '7790013000005', 255.00, 1),  -- Frutillas Congeladas
    (2, '7790013000006', 125.00, 1),  -- Zanahorias Baby
    (2, '7790003000011', 70.50, 1),   -- Manzanas Rojas
    (2, '7790003000028', 50.00, 1),   -- Tomates
    (2, '7790004000011', 115.00, 1),  -- Pan de Molde Blanco
    (2, '7790004000028', 155.50, 1),  -- Facturas Variadas
    (2, '7790014000007', 155.00, 1),  -- Baguette Artesanal
    (2, '7790014000008', 82.50, 1),   -- Galletas Digestivas
    (2, '7790005000011', 200.00, 1),  -- Gaseosa Regular Coca-Cola
    (2, '7790005000028', 105.00, 1),  -- Agua Mineral con Gas
    (2, '7790005000035', 305.00, 1),  -- Vino Tinto
    (2, '7790015000009', 42.50, 1),   -- Té Chai
    (2, '7790015000010', 285.00, 1),  -- Vino Rosado
    (2, '7790006000011', 90.00, 1),   -- Lentejas
    (2, '7790006000028', 82.00, 1),   -- Atún en Lata
    (2, '7790016000011', 108.00, 1),  -- Garbanzos
    (2, '7790016000012', 100.50, 1),  -- Porotos Rojos
    (2, '7790017000013', 78.00, 1),   -- Pasta Dental Blanqueadora
    (2, '7790017000014', 135.00, 1),  -- Acondicionador Hidratante
    (2, '7790007000011', 98.50, 1),   -- Papel Higiénico Doble Hoja
    (2, '7790007000028', 87.00, 1),   -- Shampoo Anticaspa
    (2, '7790008000011', 68.00, 1),   -- Lavandina
    (2, '7790008000028', 145.00, 1),  -- Detergente para Ropa
    (2, '7790018000015', 88.00, 1),   -- Limpiador Multiuso
    (2, '7790018000016', 125.00, 1),  -- Suavizante para Ropa
    (2, '7790009000028', 83.00, 1),   -- Café Instantáneo
    (2, '7790009000035', 170.00, 1),  -- Yerba Mate
    (2, '7790009000059', 80.00, 1),   -- Galletas Sin Gluten
    (2, '7790009000066', 191.00, 1),  -- Cerveza Artesanal


	-- Sucursal 3: Disco - Rosario
    (3, '7790001000011', 130.00, 1),  -- Leche Entera La Serenísima
    (3, '7790011000001', 210.00, 1),  -- Leche de Almendras Silk
    (3, '7790011000002', 225.75, 1),  -- Yogur Vegano
    (3, '7790002000011', 440.00, 1),  -- Bife de Res
    (3, '7790012000003', 190.75, 1),  -- Salchichas Viena
    (3, '7790012000004', 415.00, 1),  -- Costilla de Cerdo
    (3, '7790013000005', 255.00, 1),  -- Frutillas Congeladas
    (3, '7790013000006', 125.00, 1),  -- Zanahorias Baby
    (3, '7790003000011', 70.50, 1),   -- Manzanas Rojas
    (3, '7790003000028', 50.00, 1),   -- Tomates
    (3, '7790004000011', 115.00, 1),  -- Pan de Molde Blanco
    (3, '7790004000028', 155.50, 1),  -- Facturas Variadas
    (3, '7790014000007', 155.00, 1),  -- Baguette Artesanal
    (3, '7790014000008', 82.50, 1),   -- Galletas Digestivas
    (3, '7790005000011', 200.00, 1),  -- Gaseosa Regular Coca-Cola
    (3, '7790005000028', 105.00, 1),  -- Agua Mineral con Gas
    (3, '7790005000035', 305.00, 1),  -- Vino Tinto
    (3, '7790015000009', 42.50, 1),   -- Té Chai
    (3, '7790015000010', 285.00, 1),  -- Vino Rosado
    (3, '7790006000011', 90.00, 1),   -- Lentejas
    (3, '7790006000028', 82.00, 1),   -- Atún en Lata
    (3, '7790016000011', 108.00, 1),  -- Garbanzos
    (3, '7790016000012', 100.50, 1),  -- Porotos Rojos
    (3, '7790017000013', 78.00, 1),   -- Pasta Dental Blanqueadora
    (3, '7790017000014', 135.00, 1),  -- Acondicionador Hidratante
    (3, '7790007000011', 98.50, 1),   -- Papel Higiénico Doble Hoja
    (3, '7790007000028', 87.00, 1),   -- Shampoo Anticaspa
    (3, '7790008000011', 68.00, 1),   -- Lavandina
    (3, '7790008000028', 145.00, 1),  -- Detergente para Ropa
    (3, '7790018000015', 88.00, 1),   -- Limpiador Multiuso
    (3, '7790018000016', 125.00, 1),  -- Suavizante para Ropa
    (3, '7790009000028', 83.00, 1),   -- Café Instantáneo
    (3, '7790009000035', 170.00, 1),  -- Yerba Mate
    (3, '7790009000059', 80.00, 1),   -- Galletas Sin Gluten
    (3, '7790009000066', 191.00, 1),  -- Cerveza Artesanal

    -- Sucursal 4: Disco - Salta Capital
    (4, '7790001000011', 130.00, 1),  -- Leche Entera La Serenísima
    (4, '7790011000001', 210.00, 1),  -- Leche de Almendras Silk
    (4, '7790011000002', 225.75, 1),  -- Yogur Vegano
    (4, '7790002000011', 440.00, 1),  -- Bife de Res
    (4, '7790012000003', 190.75, 1),  -- Salchichas Viena
    (4, '7790012000004', 415.00, 1),  -- Costilla de Cerdo
    (4, '7790013000005', 255.00, 1),  -- Frutillas Congeladas
    (4, '7790013000006', 125.00, 1),  -- Zanahorias Baby
    (4, '7790003000011', 70.50, 1),   -- Manzanas Rojas
    (4, '7790003000028', 50.00, 1),   -- Tomates
    (4, '7790004000011', 115.00, 1),  -- Pan de Molde Blanco
    (4, '7790004000028', 155.50, 1),  -- Facturas Variadas
    (4, '7790014000007', 155.00, 1),  -- Baguette Artesanal
    (4, '7790014000008', 82.50, 1),   -- Galletas Digestivas
    (4, '7790005000011', 200.00, 1),  -- Gaseosa Regular Coca-Cola
    (4, '7790005000028', 105.00, 1),  -- Agua Mineral con Gas
    (4, '7790005000035', 305.00, 1),  -- Vino Tinto
    (4, '7790015000009', 42.50, 1),   -- Té Chai
    (4, '7790015000010', 285.00, 1),  -- Vino Rosado
    (4, '7790006000011', 90.00, 1),   -- Lentejas
    (4, '7790006000028', 82.00, 1),   -- Atún en Lata
    (4, '7790016000011', 108.00, 1),  -- Garbanzos
    (4, '7790016000012', 100.50, 1),  -- Porotos Rojos
    (4, '7790017000013', 78.00, 1),   -- Pasta Dental Blanqueadora
    (4, '7790017000014', 135.00, 1),  -- Acondicionador Hidratante
    (4, '7790007000011', 98.50, 1),   -- Papel Higiénico Doble Hoja
    (4, '7790007000028', 87.00, 1),   -- Shampoo Anticaspa
    (4, '7790008000011', 68.00, 1),   -- Lavandina
    (4, '7790008000028', 145.00, 1),  -- Detergente para Ropa
    (4, '7790018000015', 88.00, 1),   -- Limpiador Multiuso
    (4, '7790018000016', 125.00, 1),  -- Suavizante para Ropa
    (4, '7790009000028', 83.00, 1),   -- Café Instantáneo
    (4, '7790009000035', 170.00, 1),  -- Yerba Mate
    (4, '7790009000059', 80.00, 1),   -- Galletas Sin Gluten
    (4, '7790009000066', 191.00, 1),  -- Cerveza Artesanal

	(5, '7790001000011', 130.00, 1),  -- Leche Entera La Serenísima
    (5, '7790011000001', 210.00, 1),  -- Leche de Almendras Silk
    (5, '7790011000002', 225.75, 1),  -- Yogur Vegano
    (5, '7790002000011', 440.00, 1),  -- Bife de Res
    (5, '7790012000003', 190.75, 1),  -- Salchichas Viena
    (5, '7790012000004', 415.00, 1),  -- Costilla de Cerdo
    (5, '7790013000005', 255.00, 1),  -- Frutillas Congeladas
    (5, '7790013000006', 125.00, 1),  -- Zanahorias Baby
    (5, '7790003000011', 70.50, 1),   -- Manzanas Rojas
    (5, '7790003000028', 50.00, 1),   -- Tomates
    (5, '7790004000011', 115.00, 1),  -- Pan de Molde Blanco
    (5, '7790004000028', 155.50, 1),  -- Facturas Variadas
    (5, '7790014000007', 155.00, 1),  -- Baguette Artesanal
    (5, '7790014000008', 82.50, 1),   -- Galletas Digestivas
    (5, '7790005000011', 200.00, 1),  -- Gaseosa Regular Coca-Cola
    (5, '7790005000028', 105.00, 1),  -- Agua Mineral con Gas
    (5, '7790005000035', 305.00, 1),  -- Vino Tinto
    (5, '7790015000009', 42.50, 1),   -- Té Chai
    (5, '7790015000010', 285.00, 1),  -- Vino Rosado
    (5, '7790006000011', 90.00, 1),   -- Lentejas
    (5, '7790006000028', 82.00, 1),   -- Atún en Lata
    (5, '7790016000011', 108.00, 1),  -- Garbanzos
    (5, '7790016000012', 100.50, 1),  -- Porotos Rojos
    (5, '7790017000013', 78.00, 1),   -- Pasta Dental Blanqueadora
    (5, '7790017000014', 135.00, 1),  -- Acondicionador Hidratante
    (5, '7790007000011', 98.50, 1),   -- Papel Higiénico Doble Hoja
    (5, '7790007000028', 87.00, 1),   -- Shampoo Anticaspa
    (5, '7790008000011', 68.00, 1),   -- Lavandina
    (5, '7790008000028', 145.00, 1),  -- Detergente para Ropa
    (5, '7790018000015', 88.00, 1),   -- Limpiador Multiuso
    (5, '7790018000016', 125.00, 1),  -- Suavizante para Ropa
    (5, '7790009000028', 83.00, 1),   -- Café Instantáneo
    (5, '7790009000035', 170.00, 1),  -- Yerba Mate
    (5, '7790009000059', 80.00, 1),   -- Galletas Sin Gluten
    (5, '7790009000066', 191.00, 1),  -- Cerveza Artesana

	(6, '7790001000011', 130.00, 1),  -- Leche Entera La Serenísima
    (6, '7790011000001', 210.00, 1),  -- Leche de Almendras Silk
    (6, '7790011000002', 225.75, 1),  -- Yogur Vegano
    (6, '7790002000011', 440.00, 1),  -- Bife de Res
    (6, '7790012000003', 190.75, 1),  -- Salchichas Viena
    (6, '7790012000004', 415.00, 1),  -- Costilla de Cerdo
    (6, '7790013000005', 255.00, 1),  -- Frutillas Congeladas
    (6, '7790013000006', 125.00, 1),  -- Zanahorias Baby
    (6, '7790003000011', 70.50, 1),   -- Manzanas Rojas
    (6, '7790003000028', 50.00, 1),   -- Tomates
    (6, '7790004000011', 115.00, 1),  -- Pan de Molde Blanco
    (6, '7790004000028', 155.50, 1),  -- Facturas Variadas
    (6, '7790014000007', 155.00, 1),  -- Baguette Artesanal
    (6, '7790014000008', 82.50, 1),   -- Galletas Digestivas
    (6, '7790005000011', 200.00, 1),  -- Gaseosa Regular Coca-Cola
    (6, '7790005000028', 105.00, 1),  -- Agua Mineral con Gas
    (6, '7790005000035', 305.00, 1),  -- Vino Tinto
    (6, '7790015000009', 42.50, 1),   -- Té Chai
    (6, '7790015000010', 285.00, 1),  -- Vino Rosado
    (6, '7790006000011', 90.00, 1),   -- Lentejas
    (6, '7790006000028', 82.00, 1),   -- Atún en Lata
    (6, '7790016000011', 108.00, 1),  -- Garbanzos
    (6, '7790016000012', 100.50, 1),  -- Porotos Rojos
    (6, '7790017000013', 78.00, 1),   -- Pasta Dental Blanqueadora
    (6, '7790017000014', 135.00, 1),  -- Acondicionador Hidratante
    (6, '7790007000011', 98.50, 1),   -- Papel Higiénico Doble Hoja
    (6, '7790007000028', 87.00, 1),   -- Shampoo Anticaspa
    (6, '7790008000011', 68.00, 1),   -- Lavandina
    (6, '7790008000028', 145.00, 1),  -- Detergente para Ropa
    (6, '7790018000015', 88.00, 1),   -- Limpiador Multiuso
    (6, '7790018000016', 125.00, 1),  -- Suavizante para Ropa
    (6, '7790009000028', 83.00, 1),   -- Café Instantáneo
    (6, '7790009000035', 170.00, 1),  -- Yerba Mate
    (6, '7790009000059', 80.00, 1),   -- Galletas Sin Gluten
    (6, '7790009000066', 191.00, 1);  -- Cerveza Artesana
GO
...
--InfoPrecios, Recibo lista de productos a actualizar
